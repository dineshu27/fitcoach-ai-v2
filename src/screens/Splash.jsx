...
export default function Splash() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center"
      style={{ background: "linear-gradient(180deg, #0A0A0F 0%, #0F0A1E 50%, #0A0A0F 100%)" }}>

      {/* Glow orb behind REX */}
      <div className="absolute" style={{ width: 300, height: 300, borderRadius: "50%",
        background: "radial-gradient(circle, rgba(108,99,255,0.15) 0%, transparent 70%)", pointerEvents: "none" }} />
      ...
      >
        <h1 className="text-5xl font-extrabold tracking-tight"
          style={{ color: "#F0F0FF", textShadow: "0 0 30px rgba(108,99,255,0.6)" }}>
          FitCoach<span style={{ color: "#6C63FF" }}>AI</span>
        </h1>
        <p className="mt-2 text-base font-medium" style={{ color: "#8888AA" }}>
      ...
      <motion.div
        ...
        style={{ background: "rgba(108,99,255,0.15)", border: "1px solid rgba(108,99,255,0.3)", color: "#F0F0FF" }}
      >
      ...
      <motion.div
        ...
        style={{ width: 160, height: 3, background: "rgba(108,99,255,0.2)" }}
      >
        <motion.div
